(function () {
  ...
  ready(function () {
    ...
    if (nav) {
      ...
      function syncNavTop() {
        if (!masthead) return;
        var buttonBottom = button ? button.getBoundingClientRect().bottom : 0;
        var navTop = Math.ceil(Math.max(masthead.getBoundingClientRect().bottom, buttonBottom) + 1);
